...
class DynamicLinkService {
  ...
  Future<String> createReferLink(String code) async {
    if (Platform.isAndroid) {
      ...
      final DynamicLinkParameters parameters = DynamicLinkParameters(
        ...
        link: Uri.parse("${baseUrl}/refer-friend/$code?isProduct=false"),
        androidParameters: AndroidParameters(
          packageName: 'com.shopsasta.app',
        ),

        // Other things to add as an example. We don't need it nowOnions is available at best price of ₹54.0. Find best deals on Groceries every day on ShopSasta. Signup and share with friends and family and earn. Get cashbacks and Save. FREE Home Delivery.
        // https://shopsasta.page.link/PbTdErZHYZVdPsut9
        // Onions is available at best price of ₹54.0. Find best deals on Groceries every day on ShopSasta. Signup and share with friends and family and earn. Get cashbacks and Save. FREE Home Delivery.
  ...
  Future<String> createProductLink(String linker) async {
    if (Platform.isAndroid) {
      ...
      final DynamicLinkParameters parameters = DynamicLinkParameters(
        uriPrefix: 'https://shopsasta.page.link',
        link: Uri.parse("${baseUrl}detail/$linker?isProduct=true"),
        androidParameters: AndroidParameters(
          packageName: 'com.shopsasta.app',
        ),

        // Other things to add as an example. We don't need it nowOnions is available at best price of ₹54.0. Find best deals on Groceries every day on ShopSasta. Signup and share with friends and family and earn. Get cashbacks and Save. FREE Home Delivery. 
        // https://shopsasta.page.link/uMVZvwM7THfVjXcD6
        iosParameters: IosParameters(
          bundleId: 'com.shopsasta.app',
          // minimumVersion: '1.0.1',
