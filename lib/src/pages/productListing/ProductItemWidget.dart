          ...
          InkWell(
                  ...
                  MaterialPageRoute(
                      builder: (_) => ProductWidget(
                          ...
                          routeArgument: RouteArgument(
                            id: '0',
                            imageUrl: (widget.productData.pictures == null ||
                                    widget.productData.pictures.isEmpty)
                                ? imageNotAvailable
                                : awsLink +
            ...
            child: Hero(
              ...
              child: ClipRRect(
                ...
                child: widget.productData.pictures.isEmpty
                    ? Center(
                        child: Container(
                    ...
                    : CachedNetworkImage(
                        ...
                        fit: BoxFit.cover,
                        imageUrl:
                            awsLink + widget.productData.pictures[0] + ".jpg",
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (_) => ProductWidget(
                                    ...
                                    routeArgument: RouteArgument(
                                      id: '0',
                                      imageUrl: ((widget.productData.pictures ==
                                                      null ||
                                                  widget.productData.pictures
                                                      .isEmpty)
                                              ? imageNotAvailable
                                              : awsLink +
                                                  widget.productData
