...
//The Referal Code for registeration is D580E08.Share and earn Cashbacks. Shossasta Application :https://shopsasta.page.link/SC1q66dsZiRPk6xZ6
      ...
      await prefs.setBool('isLogin', false);
//Onions is available at best price ₹20.0. Find best deals on Grocery everyday on ShopSasta. Get cashbacks and Save. Share with friends and family and earn. FREE Home Delivery. 
//https://shopsasta.page.link/tsLvjtEWFKVxjQkT9
      print("token is  null");
      if (arg.keys.toList()[0]) {
        Navigator.push(
            context,
