                                  ...
                                  Hero(
                                    ...
                                    child: Center(
                                      child: CarouselSlider(
                                        ...
                                        items: widget.itemData.pictures.isEmpty
                                            ? [
                                                Center(
                                      ...
                                      child: new DropdownButton<String>(
                                        ...
                                        onChanged: (v) {
                                          ...
                                          setState(() {
                                            ...
                                            //         context,
                                            //         listen: false)Sweet Potato is available at best price ₹50.0. Find best deals on Grocery everyday on ShopSasta. Get cashbacks and Save. Share with friends and family and earn. FREE Home Delivery.
                                            // https://shopsasta.page.link/FSZQ98zHG1hipJzv8
                                            //     .setvariant(itemData);
                                            itemData.quantIndex = 0;
                                            secondDrop = (itemData
                                                        ?.variant[itemData
                                                            .variantIndex]
                                                        ?.prices[0]
                                ...
                                Consumer<UserData>(
                                  ...
                                  return Row(
                                    ...
                                    children: <Widget>[
                                        ...
                                        child: InkWell(
                                            ...
                                            onTap: () async {
                                              ...
                                              userData?.referalCode != null
                                                  ? Share.share(
                                                      "${itemData.name} is available at best price of ₹${itemData.variant[itemData.variantIndex].prices[itemData.quantIndex].price}. Find best deals on Groceries every day on ShopSasta. Get cashback and Save. Share with friends and family and earn. FREE Home Delivery. Install App and use my referral code ${userData.referalCode ?? " "} while signing up $link")
                                                  : Share.share(
                                                      "${itemData.name} is available at best price of ₹${itemData.variant[itemData.variantIndex].prices[itemData.quantIndex].price}. Find best deals on Groceries every day on ShopSasta. Signup and share with friends and family and earn. Get cashbacks and Save. FREE Home Delivery. $link");

                                              // '${itemData.name} is avilable at cheapest Price.You can Share and Earn Cashback.Here is the link for the product ');
                                            },
                                            //Cauliflower is avilable at cheapest Price.You can Share and Earn Cashback.Here is the link for the product
                                            //https://shopsasta.page.link/JMVz2Fbuq64dWe4j7
                                            child: shareEarn(
                                                context, "SHARE & EARN")),
                                      ),
                                      ...
                                      //   return
                                      (!itemData?.stockStatus) ?? false
                                          ? Container(
                                              width: SizeConfig.w * 0.35)
                                          : Center(
                                              child: GestureDetector(
                                                onTap: (itemData?.stock ?? 1) >
                                                        0
                                                    ? () async {
                                                        bool _additem = false;
                                                        // showLoading();
