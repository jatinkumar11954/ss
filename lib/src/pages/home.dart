...
class HomeWidget extends StatefulWidget {
  ...
  HomeWidget({Key key, this.parentScaffoldKey, this.fromDeep, this.linker})
      : super(key: key);
  ...
  getProductList({bool refresh}) async {
    ...
    if (category != null) {
      ...
      if (widget?.fromDeep ?? false) {
        ...
        //https://shopsasta.page.link/Qe9RqTmUfg1RwhXR7
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => ProductWidget(
            ...
            return SafeArea(
              child: Scaffold(
                ...
                appBar: PreferredSize(
                  preferredSize: Size.fromHeight(SizeConfig.w * 0.21),
                  child: AppBar(
