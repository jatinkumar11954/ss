          ...
          body:
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: () =>
                    Navigator.of(context).pushNamed('/delivery-coverage'),
                trailing: Icon(Icons.arrow_forward_ios),
              ),
              Divider(
                thickness: 1,
              ...
              ListTile(
                ...
                onTap: () => Navigator.of(context).pushNamed('/how-it-works'),
                trailing: Icon(Icons.arrow_forward_ios),
              ),
              Divider(
                thickness: 1,
              ...
              ListTile(
                ...
                onTap: () =>
                    Navigator.of(context).pushNamed('/cancellation-policy'),
                trailing: Icon(Icons.arrow_forward_ios),
              ),
              Divider(
                thickness: 1,
              ...
              ListTile(
                ...
                onTap: () => Navigator.of(context).pushNamed('/return-refund'),
                trailing: Icon(Icons.arrow_forward_ios),
              ),
              Divider(
                thickness: 1,
