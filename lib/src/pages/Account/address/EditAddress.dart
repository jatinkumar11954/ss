...
class _EditAddressState extends State<EditAddress> {
  ...
  getAddress() async {
    ...
    // Map res = await ApiServices.getRequest("/api/city?pincode=$pin");
    // print("all address");
    // print(res);
    // stopLoading();
    ...
    // }
    Map res = await ApiServices.getRequest(cityEndPoint);
    print("all address");
    print(res);
    stopLoading();
    if (res != null && res["status"])
      citiesData = (Cities.fromMap(res));
    else {
      citiesData = Cities(cities: ["Hyderabad", "Kukatpally"]);
                ...
                child: Wrap(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "PinCode *",
                          // suffix: Text(
                          //     "To edit text delete the address and add new address"),
                          // suffixText: "Enter your 10 digit Mobile Number",
                    ...
                    Padding(
                      ...
                      child: Text(
                          "To edit pincode delete this address and add new address"),
                    ),
