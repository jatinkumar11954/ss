                ...
                GestureDetector(
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) => ProductWidget(
                                ...
                                product: ((widget.product.pictures == null ||
                                            widget.product.pictures.isEmpty)
                                        ? imageNotAvailable
                                        : awsLink +
                                ...
                                routeArgument: RouteArgument(
                                  id: '0',
                                  imageUrl: ((widget.product.pictures == null ||
                                              widget.product.pictures.isEmpty)
                                          ? imageNotAvailable
                                          : awsLink +
                                              widget.product.pictures[0]) +
                  ...
                  child: Hero(
                    ...
                    child: Padding(
                      ...
                      child: widget.product.pictures.isEmpty
                          ? Center(
                              child: Image.asset(
                          ...
                          : CachedNetworkImage(
                              ...
                              fit: BoxFit.fill,
                              imageUrl:
                                  awsLink + widget.product.pictures[0] + ".jpg",
